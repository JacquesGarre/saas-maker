...
use App\Tests\Stubs\Domain\User\UserLoggedInDomainEventStub;
use DateTime;
use PHPUnit\Framework\TestCase;
use DateTimeImmutable;

final class UserLoggedInDomainEventTest extends TestCase
{
    ...
    {
        $domainEvent = UserLoggedInDomainEventStub::random();
